from .prompt._judge import PairwiseLLMJudgePrompt, PointwiseLLMJudgePrompt, PairwiseLLMJudgeSystemMessage, PointwiseLLMJudgeSystemMessage
from .prompt import PromptTransformer


def _pointwise_llm_judge(model):
    prompt = PromptTransformer(system_message=PointwiseLLMJudgeSystemMessage,
...
def _pairwise_llm_judge(model):
    prompt = PromptTransformer(system_message=PairwiseLLMJudgeSystemMessage,
